...
| 내 일정 목록 조회 | GET    | `/schedules/me`                         | 세션 필요                              | 일정 목록                                 | 200 OK         |
...
CREATE TABLE schedule (
    ...
    created_at DATETIME(6),
    modified_at DATETIME(6),
    CONSTRAINT fk_schedule_author FOREIGN KEY (author_id)
...
CREATE TABLE comment (
    ...
    CONSTRAINT fk_comment_author FOREIGN KEY (author_id)
        REFERENCES author(id)
        ON DELETE RESTRICT,
    CONSTRAINT fk_comment_schedule FOREIGN KEY (schedule_id)
